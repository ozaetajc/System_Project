<?php
   ...
   if($conn->connect_error){
    ...
    $stmt->bind_param("sssssssssssssissssississibbssssssiissssssiissssssii",$course,$fname,$lname,$mname,$sname,$year,$sy,$admit,$term,$gender,$status,$nationality,$religion,$age,$dob,$pob,$email,$address,$mobile,$elementary,$school_address1,$year_graduated1,$juniorhigh,$school_address2,$year_graduated2,$photo,$form_137,
    $father_fname,$father_lname,$father_mname,$father_sname,$father_occupation,$father_email,$father_mobile,$father_age,$mother_fname,$mother_lname,$mother_mname,$mother_sname,$mother_occupation,$mother_email,$mother_mobile,$mother_age,
    $guardian_fname,$guardian_lname,$guardian_mname,$guardian_sname,$guardian_occupation,$guardian_email,$guardian_mobile,$guardian_age);
    
    if ($stmt->execute()) {
        $target_dir = "uploads/";
    $target_photo = $target_dir . uniqid() . '_' . $photo;
    $target_form_137 = $target_dir . uniqid() . '_' . $form_137;

    move_uploaded_file($_FILES['photo']['tmp_name'], $target_photo);
    move_uploaded_file($_FILES['form_137']['tmp_name'], $target_form_137);
