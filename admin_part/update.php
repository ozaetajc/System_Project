...
.container {
    ...
    <label for="newFirstName">FIRST NAME:</label>
        <input type="text" name="newFirstName" value="<?php echo $row['fname']; ?>" required><br>

        <label for="newLastName">LAST NAME:</label>
        <input type="text" name="newLastName" value="<?php echo $row['lname']; ?>" required><br>

        <label for="newCourse">COURSE:</label>
        <input type="text" name="newCourse" value="<?php echo $row['course']; ?>" required><br>

        <label for="newYear">YEAR LEVEL:</label>
        <input type="text" name="newYear" value="<?php echo $row['year']; ?>" required><br>

        <label for="newEmail">EMAIL ADDRESS:</label>
        <input type="email" name="newEmail" value="<?php echo $row['email']; ?>" required><br>

        <label for="newMobile">MOBILE NUMBER:</label>
        <input type="text" name="newMobile" value="<?php echo $row['mobile']; ?>" required><br><br>
